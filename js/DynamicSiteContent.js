    ...
    <div class="container">
      ...
      <div class="nav-links nav-container">
        <ul class="nav">
          ...
          <li id="navResume"><a id="navResumeButton" class="button nav-button contact-button" href="www.strahinjacokic.com/resume.html" target="_blank">RESUME</a></li>
        </ul>
      </div>
  ...
  <section class="section-container hero" id="hero">
    <div class="container">
      ...
      <div class="text-container">
        ...
        <a id="resumeButton" class="button" href="www.strahinjacokic.com/resume.html" target="_blank"></a>
      </div>
